...
//        secsSpan:30,
   ...
   function compInitate(options,data,elem){        
    ...
    var mainObj={
        ...
        */
        generateDOMRef :function(){
            ...
            this.secsHeaderScroller=$($this).find('.secsHeader-scroller');            (this.generateHours()).appendTo([this.hoursHeader,this.sliderWrapper]);
    ...
    //        this.headerInner.height(this.chrt.height()+2);
        ...
        */
        generateSecondsHeader:function(initialValue)
        {
            ...
            for(var i=0;i<len;i++)
            {
                ...
                tempVal=('00000'+minCorrection).slice(-6);                this.liArr[i]=tempVal.slice(0,2)+':'+tempVal.slice(2,4)+':'+tempVal.slice(4,6);
                list.append($('<li>'+this.liArr[i]+'</li>'));
            }
        },   
        ...
        */
        ...
        {
            var rowContainer=$('<div class="row-container"><div class="rowDate">'+obj.label+'</div></div>');
        ...
        */
        createPopup:function(dataObj,pos)
        {
            ...
            var popHeader=$('<div class="pop-header"><img src='+dataObj['status']+'.png>'+dataObj['status']+'<span class="close">x</span></div>');
    ...
    */
        ...
        toggleTimeUnitButton:function(elem)
        {
            var headerWidth=mainObj.header.width();
                ...
                if(elem=='hours')
                {   
                    $($this).find('.header .row').width(headerWidth);
                ...
                {     
                    $($this).find('.header .row').width(headerWidth*12);
                    mainObj.headerInner.width(headerWidth);
                ...
                else 
                {
                    ...
                    $($this).find('.header .row').width(headerWidth*240);
    ...
    */
            $($this).find('.header').on('scroll',function(e){        
            ...
            $($this).find(".secsScroller").scroll(function(){
                $($this).find(".header").scrollLeft($($this).find(".secsScroller").scrollLeft());
            });
